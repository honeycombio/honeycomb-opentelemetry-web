...
You can run this example to see the SDK in action. It doubles as a **session rollover
demo**: the session windows are turned down to seconds, so you can watch `session.id`
expire, persist and roll over while you look at the page.
