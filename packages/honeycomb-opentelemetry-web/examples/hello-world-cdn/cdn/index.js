var HNY = (function (exports) {
    ...
    var _globalThis$7 = typeof globalThis === 'object' ? globalThis : typeof self === 'object' ? self : typeof window === 'object' ? window : typeof global === 'object' ? global : {};
    ...
    var NoopGaugeMetric = /** @class */function (_super) {
      __extends$d(NoopGaugeMetric, _super);
     ...
     * limitations under the License.
     */
    var NoopLogger$4 = /** @class */function () {
      function NoopLogger() {}
     ...
     * limitations under the License.
     */
    var NoopLoggerProvider$4 = /** @class */function () {
      function NoopLoggerProvider() {}
      NoopLoggerProvider.prototype.getLogger = function (_name, _version, _options) {
        return new NoopLogger$4();
      };
      return NoopLoggerProvider;
    }();
    var NOOP_LOGGER_PROVIDER$4 = new NoopLoggerProvider$4();
    ...
    /** only globals that common to node and browsers are allowed */
    // eslint-disable-next-line node/no-unsupported-features/es-builtins, no-undef
    var _globalThis$6 = typeof globalThis === 'object' ? globalThis : typeof self === 'object' ? self : typeof window === 'object' ? window : typeof global === 'object' ? global : {};
     ...
     * limitations under the License.
     */
    var GLOBAL_LOGS_API_KEY$4 = Symbol.for('io.opentelemetry.js.api.logs');
    var _global$4 = _globalThis$6;
    /**
     ...
     */
    function makeGetter$4(requiredVersion, instance, fallback) {
     ...
     */
    var API_BACKWARDS_COMPATIBILITY_VERSION$4 = 1;
    ...
    var LogsAPI$4 = /** @class */function () {
      ...
      LogsAPI.prototype.setGlobalLoggerProvider = function (provider) {
        if (_global$4[GLOBAL_LOGS_API_KEY$4]) {
          return this.getLoggerProvider();
        }
        _global$4[GLOBAL_LOGS_API_KEY$4] = makeGetter$4(API_BACKWARDS_COMPATIBILITY_VERSION$4, provider, NOOP_LOGGER_PROVIDER$4);
        return provider;
      };
      /**
      ...
      LogsAPI.prototype.getLoggerProvider = function () {
        var _a, _b;
        return (_b = (_a = _global$4[GLOBAL_LOGS_API_KEY$4]) === null || _a === void 0 ? void 0 : _a.call(_global$4, API_BACKWARDS_COMPATIBILITY_VERSION$4)) !== null && _b !== void 0 ? _b : NOOP_LOGGER_PROVIDER$4;
      };
      /**
      ...
      LogsAPI.prototype.disable = function () {
        delete _global$4[GLOBAL_LOGS_API_KEY$4];
      };
      return LogsAPI;
    }();
     ...
     * limitations under the License.
     */
    var logs$4 = LogsAPI$4.getInstance();
    ...
    function registerInstrumentations(options) {
      ...
      var loggerProvider = options.loggerProvider || logs$4.getLoggerProvider();
    ...
    /** only globals that common to node and browsers are allowed */
    // eslint-disable-next-line node/no-unsupported-features/es-builtins, no-undef
    var _globalThis$5 = typeof globalThis === 'object' ? globalThis : typeof self === 'object' ? self : typeof window === 'object' ? window : typeof global === 'object' ? global : {};
     ...
     */
    function getEnv() {
      var globalEnv = parseEnvironment(_globalThis$5);
      return Object.assign({}, DEFAULT_ENVIRONMENT, globalEnv);
    }
    function getEnvWithoutDefaults() {
      return parseEnvironment(_globalThis$5);
    }
     ...
     * limitations under the License.
     */
    var otperformance$2 = performance;
    ...
    function isTimeInput(value) {
      return isTimeInputHrTime$2(value) || typeof value === 'number' || value instanceof Date;
    }
    /**
    ...
    var Resource = /** @class */function () {
      ...
      Resource.prototype.merge = function (other) {
        ...
        var mergedSyncAttributes = __assign$6(__assign$6({}, this._syncAttributes), (_a = other._syncAttributes) !== null && _a !== void 0 ? _a : other.attributes);
        ...
        var mergedAttributesPromise = Promise.all([this._asyncAttributesPromise, other._asyncAttributesPromise]).then(function (_a) {
          ...
          return __assign$6(__assign$6(__assign$6(__assign$6({}, _this._syncAttributes), thisAsyncAttributes), (_b = other._syncAttributes) !== null && _b !== void 0 ? _b : other.attributes), otherAsyncAttributes);
        });
    ...
    var Span = /** @class */function () {
      ...
      attributes) {
        ...
        this._performanceOffset = now - (this._performanceStartTime + getTimeOrigin$2());
      ...
      Span.prototype._getTime = function (inp) {
        ...
        var msDuration = otperformance$2.now() - this._performanceStartTime;
    ...
    var BatchSpanProcessor = /** @class */function (_super) {
      __extends$c(BatchSpanProcessor, _super);
    ...
    var WebTracerProvider = /** @class */function (_super) {
      __extends$b(WebTracerProvider, _super);
      /**
       * Constructs a new Tracer instance.
     ...
     * @param resource
     */
    function addSpanNetworkEvents$2(span, resource) {
    ...
    var OTLPExporterError = /** @class */function (_super) {
      __extends$a(OTLPExporterError, _super);
    ...
    function sendWithXhr(body, url, headers, exporterTimeout, onSuccess, onError) {
      ...
      var sendWithRetry = function (retries, minDelay) {
        ...
        Object.entries(__assign$5(__assign$5({}, defaultHeaders), headers)).forEach(function (_a) {
    ...
    var OTLPExporterBrowserBase = /** @class */function (_super) {
      __extends$9(OTLPExporterBrowserBase, _super);
      /**
       * @param config
       * @param serializer
       * @param contentType
      ...
      OTLPExporterBrowserBase.prototype.send = function (items, onSuccess, onError) {
        ...
        var promise = new Promise(function (resolve, reject) {
          if (_this._useXHR) {
            sendWithXhr(body, _this.url, __assign$4(__assign$4({}, _this._headers), {
    ...
    var encodeTimestamp = typeof BigInt !== 'undefined' ? encodeAsString : hrTimeToNanoseconds$2;
    ...
    var OTLPTraceExporter = /** @class */function (_super) {
      __extends$8(OTLPTraceExporter, _super);
    ...
    let InstrumentationAbstract$4 = class InstrumentationAbstract {
     ...
     */
    class WebVitalsInstrumentation extends InstrumentationAbstract$4 {
      constructor({
        enabled = true,
     ...
     */
    class GlobalErrorsInstrumentation extends InstrumentationAbstract$4 {
      constructor({
        enabled = true
      } = {}) {
        const config = {
        ...
        super('@honeycombio/instrumentation-global-errors', VERSION$2, config);
        this.onError = event => {
     ...
     * limitations under the License.
     */
    var NoopLogger$3 = /** @class */function () {
      function NoopLogger() {}
      NoopLogger.prototype.emit = function (_logRecord) {};
      return NoopLogger;
    }();
     ...
     * limitations under the License.
     */
    var NoopLoggerProvider$3 = /** @class */function () {
      function NoopLoggerProvider() {}
      NoopLoggerProvider.prototype.getLogger = function (_name, _version, _options) {
        return new NoopLogger$3();
      };
      return NoopLoggerProvider;
    }();
    var NOOP_LOGGER_PROVIDER$3 = new NoopLoggerProvider$3();
    ...
    /** only globals that common to node and browsers are allowed */
    // eslint-disable-next-line node/no-unsupported-features/es-builtins, no-undef
    var _globalThis$4 = typeof globalThis === 'object' ? globalThis : typeof self === 'object' ? self : typeof window === 'object' ? window : typeof global === 'object' ? global : {};
     ...
     * limitations under the License.
     */
    var GLOBAL_LOGS_API_KEY$3 = Symbol.for('io.opentelemetry.js.api.logs');
    var _global$3 = _globalThis$4;
    /**
     * Make a function which accepts a version integer and returns the instance of an API if the version
     * is compatible, or a fallback version (usually NOOP) if it is not.
     *
     ...
     * @param fallback Fallback instance, usually NOOP, which will be returned if the required version is not compatible
     */
    function makeGetter$3(requiredVersion, instance, fallback) {
      return function (version) {
        return version === requiredVersion ? instance : fallback;
      };
    }
     ...
     * attempting to get it, a NOOP API implementation will be returned.
     */
    var API_BACKWARDS_COMPATIBILITY_VERSION$3 = 1;
    ...
    var LogsAPI$3 = /** @class */function () {
      ...
      LogsAPI.prototype.setGlobalLoggerProvider = function (provider) {
        if (_global$3[GLOBAL_LOGS_API_KEY$3]) {
          return this.getLoggerProvider();
        }
        _global$3[GLOBAL_LOGS_API_KEY$3] = makeGetter$3(API_BACKWARDS_COMPATIBILITY_VERSION$3, provider, NOOP_LOGGER_PROVIDER$3);
        return provider;
      };
      /**
       * Returns the global logger provider.
      ...
      LogsAPI.prototype.getLoggerProvider = function () {
        var _a, _b;
        return (_b = (_a = _global$3[GLOBAL_LOGS_API_KEY$3]) === null || _a === void 0 ? void 0 : _a.call(_global$3, API_BACKWARDS_COMPATIBILITY_VERSION$3)) !== null && _b !== void 0 ? _b : NOOP_LOGGER_PROVIDER$3;
      };
      /**
       * Returns a logger from the global logger provider.
       *
      ...
      /** Remove the global logger provider */
      LogsAPI.prototype.disable = function () {
        delete _global$3[GLOBAL_LOGS_API_KEY$3];
      };
      return LogsAPI;
    }();
     ...
     * limitations under the License.
     */
    var logs$3 = LogsAPI$3.getInstance();
     ...
     */
    var InstrumentationAbstract$3 = /** @class */function () {
      function InstrumentationAbstract(instrumentationName, instrumentationVersion, config) {
        ...
        this._tracer = trace.getTracer(instrumentationName, instrumentationVersion);
        this._meter = metrics.getMeter(instrumentationName, instrumentationVersion);
        this._logger = logs$3.getLogger(instrumentationName, instrumentationVersion);
        this._updateMetricInstruments();
      }
     ...
     */
    var InstrumentationBase$3 = /** @class */function (_super) {
      __extends$7(InstrumentationBase, _super);
     ...
     */
    function safeExecuteInTheMiddle$2(execute, onFinish, preventThrowingError) {
      var error;
      var result;
      try {
        result = execute();
    ...
    var DocumentLoadInstrumentation = /** @class */function (_super) {
      __extends$6(DocumentLoadInstrumentation, _super);
      ...
      DocumentLoadInstrumentation.prototype._collectPerformance = function () {
        ...
        context.with(propagation.extract(ROOT_CONTEXT, {
          ...
          var _a;
          var rootSpan = _this._startSpan(AttributeNames$3.DOCUMENT_LOAD, PerformanceTimingNames$2.FETCH_START, entries);
          if (!rootSpan) {
            return;
          }
      ...
      DocumentLoadInstrumentation.prototype._addCustomAttributesOnSpan = function (span, applyCustomAttributesOnSpan) {
        ...
        if (applyCustomAttributesOnSpan) {
          safeExecuteInTheMiddle$2(function () {
     ...
     * limitations under the License.
     */
    var NoopLogger$2 = /** @class */function () {
      function NoopLogger() {}
      NoopLogger.prototype.emit = function (_logRecord) {};
      return NoopLogger;
    }();
     ...
     * limitations under the License.
     */
    var NoopLoggerProvider$2 = /** @class */function () {
      function NoopLoggerProvider() {}
      NoopLoggerProvider.prototype.getLogger = function (_name, _version, _options) {
        return new NoopLogger$2();
      };
      return NoopLoggerProvider;
    }();
    var NOOP_LOGGER_PROVIDER$2 = new NoopLoggerProvider$2();
     ...
     * limitations under the License.
     */
    var GLOBAL_LOGS_API_KEY$2 = Symbol.for('io.opentelemetry.js.api.logs');
     ...
     * @param fallback Fallback instance, usually NOOP, which will be returned if the required version is not compatible
     */
    function makeGetter$2(requiredVersion, instance, fallback) {
      return function (version) {
        return version === requiredVersion ? instance : fallback;
      };
    }
     ...
     * attempting to get it, a NOOP API implementation will be returned.
     */
    var API_BACKWARDS_COMPATIBILITY_VERSION$2 = 1;
    ...
    var LogsAPI$2 = /** @class */function () {
      ...
      LogsAPI.prototype.setGlobalLoggerProvider = function (provider) {
        if (_global$2[GLOBAL_LOGS_API_KEY$2]) {
          return this.getLoggerProvider();
        }
        _global$2[GLOBAL_LOGS_API_KEY$2] = makeGetter$2(API_BACKWARDS_COMPATIBILITY_VERSION$2, provider, NOOP_LOGGER_PROVIDER$2);
        return provider;
      };
      /**
       * Returns the global logger provider.
      ...
      LogsAPI.prototype.getLoggerProvider = function () {
        var _a, _b;
        return (_b = (_a = _global$2[GLOBAL_LOGS_API_KEY$2]) === null || _a === void 0 ? void 0 : _a.call(_global$2, API_BACKWARDS_COMPATIBILITY_VERSION$2)) !== null && _b !== void 0 ? _b : NOOP_LOGGER_PROVIDER$2;
      };
      /**
       * Returns a logger from the global logger provider.
       *
      ...
      /** Remove the global logger provider */
      LogsAPI.prototype.disable = function () {
        delete _global$2[GLOBAL_LOGS_API_KEY$2];
      };
      return LogsAPI;
    }();
     ...
     * limitations under the License.
     */
    var logs$2 = LogsAPI$2.getInstance();
     ...
     * Base abstract internal class for instrumenting node and web plugins
     */
    var InstrumentationAbstract$2 = /** @class */function () {
      function InstrumentationAbstract(instrumentationName, instrumentationVersion, config) {
        this.instrumentationName = instrumentationName;
        this.instrumentationVersion = instrumentationVersion;
        this._config = {};
        ...
        this._tracer = trace.getTracer(instrumentationName, instrumentationVersion);
        this._meter = metrics.getMeter(instrumentationName, instrumentationVersion);
        this._logger = logs$2.getLogger(instrumentationName, instrumentationVersion);
        this._updateMetricInstruments();
      }
      Object.defineProperty(InstrumentationAbstract.prototype, "meter", {
        /* Returns meter */
     ...
     * Base abstract class for instrumenting web plugins
     */
    var InstrumentationBase$2 = /** @class */function (_super) {
      __extends$5(InstrumentationBase, _super);
      function InstrumentationBase(instrumentationName, instrumentationVersion, config) {
        var _this = _super.call(this, instrumentationName, instrumentationVersion, config) || this;
        if (_this._config.enabled) {
          _this.enable();
     ...
     * @param onFinish - callback to run when execute finishes
     */
    function safeExecuteInTheMiddle$1(execute, onFinish, preventThrowingError) {
      var error;
      var result;
      try {
        result = execute();
    ...
    function findMainRequest$1(resources, corsPreFlightRequestEndTime, spanEndTimeHR) {
      var spanEndTime = hrTimeToNanoseconds$1(spanEndTimeHR);
      var minTime = hrTimeToNanoseconds$1(timeInputToHrTime$1(corsPreFlightRequestEndTime));
      var mainRequest = resources[1];
      var bestGap;
      var length = resources.length;
      for (var i = 1; i < length; i++) {
        var resource = resources[i];
        var resourceStartTime = hrTimeToNanoseconds$1(timeInputToHrTime$1(resource[PerformanceTimingNames$1.FETCH_START]));
        var resourceEndTime = hrTimeToNanoseconds$1(timeInputToHrTime$1(resource[PerformanceTimingNames$1.RESPONSE_END]));
    ...
    function filterResourcesForSpan$1(spanUrl, startTimeHR, endTimeHR, resources, ignoredResources, initiatorType) {
      var startTime = hrTimeToNanoseconds$1(startTimeHR);
      var endTime = hrTimeToNanoseconds$1(endTimeHR);
    ...
    function shouldPropagateTraceHeaders$1(spanUrl, propagateTraceHeaderCorsUrls) {
      ...
      if (parsedSpanUrl.origin === getOrigin$1()) {
        ...
        return propagateTraceHeaderUrls.some(function (propagateTraceHeaderUrl) {
          return urlMatches$1(spanUrl, propagateTraceHeaderUrl);
        });
      }
    }
    ...
    var FetchInstrumentation = /** @class */function (_super) {
      __extends$4(FetchInstrumentation, _super);
      ...
      FetchInstrumentation.prototype._applyAttributesAfterFetch = function (span, request, result) {
        ...
        if (applyCustomAttributesOnSpan) {
          safeExecuteInTheMiddle$1(function () {
      ...
      FetchInstrumentation.prototype.enable = function () {
        ...
        if (isWrapped$2(fetch)) {
          this._unwrap(_globalThis$2, 'fetch');
          this._diag.debug('removing previous patch for constructor');
        }
        this._wrap(_globalThis$2, 'fetch', this._patchConstructor());
      };
      /**
     ...
     * limitations under the License.
     */
    var NoopLogger$1 = /** @class */function () {
      function NoopLogger() {}
      NoopLogger.prototype.emit = function (_logRecord) {};
      return NoopLogger;
    }();
     ...
     * limitations under the License.
     */
    var NoopLoggerProvider$1 = /** @class */function () {
      function NoopLoggerProvider() {}
      NoopLoggerProvider.prototype.getLogger = function (_name, _version, _options) {
    ...
    var LogsAPI$1 = /** @class */function () {
      ...
      LogsAPI.prototype.getLoggerProvider = function () {
        var _a, _b;
        return (_b = (_a = _global$1[GLOBAL_LOGS_API_KEY$1]) === null || _a === void 0 ? void 0 : _a.call(_global$1, API_BACKWARDS_COMPATIBILITY_VERSION$1)) !== null && _b !== void 0 ? _b : NOOP_LOGGER_PROVIDER$1;
      };
      /**
       * Returns a logger from the global logger provider.
       *
     ...
     * Base abstract class for instrumenting web plugins
     */
    var InstrumentationBase$1 = /** @class */function (_super) {
      __extends$3(InstrumentationBase, _super);
      function InstrumentationBase(instrumentationName, instrumentationVersion, config) {
        var _this = _super.call(this, instrumentationName, instrumentationVersion, config) || this;
        if (_this._config.enabled) {
          _this.enable();
    ...
    var UserInteractionInstrumentation = /** @class */function (_super) {
      __extends$2(UserInteractionInstrumentation, _super);
      ...
      UserInteractionInstrumentation.prototype._unpatchHistoryApi = function () {
        if (isWrapped$1(history.replaceState)) this._unwrap(history, 'replaceState');
        if (isWrapped$1(history.pushState)) this._unwrap(history, 'pushState');
        if (isWrapped$1(history.back)) this._unwrap(history, 'back');
        if (isWrapped$1(history.forward)) this._unwrap(history, 'forward');
        if (isWrapped$1(history.go)) this._unwrap(history, 'go');
      };
      /**
      ...
      UserInteractionInstrumentation.prototype.enable = function () {
        ...
        if (ZoneWithPrototype) {
          if (isWrapped$1(ZoneWithPrototype.prototype.runTask)) {
            this._unwrap(ZoneWithPrototype.prototype, 'runTask');
            this._diag.debug('removing previous patch from method runTask');
          }
          if (isWrapped$1(ZoneWithPrototype.prototype.scheduleTask)) {
            this._unwrap(ZoneWithPrototype.prototype, 'scheduleTask');
            this._diag.debug('removing previous patch from method scheduleTask');
          }
          if (isWrapped$1(ZoneWithPrototype.prototype.cancelTask)) {
    ...
    var InstrumentationBase = /** @class */function (_super) {
      __extends$1(InstrumentationBase, _super);
      function InstrumentationBase(instrumentationName, instrumentationVersion, config) {
        var _this = _super.call(this, instrumentationName, instrumentationVersion, config) || this;
        if (_this._config.enabled) {
          _this.enable();
